 ...
 */
export interface SimplePersistenceConfig<T extends Record<string, unknown> = GlobalState> {
    /**
 ...
 */
export interface PersistenceConfig<T extends Record<string, unknown> = GlobalState> {
    /**
